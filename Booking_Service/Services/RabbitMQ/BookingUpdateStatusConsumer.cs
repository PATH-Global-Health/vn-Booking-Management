...
{
    public class BookingUpdateStatusConsumer : BackgroundService
    {
        ...
        public BookingUpdateStatusConsumer(IServiceScopeFactory scopeFactory, IConfiguration configuration)
        {
