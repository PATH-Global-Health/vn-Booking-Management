...
{
    public class BookingUpdateStatusConsumerV2 : BackgroundService
    {
        ...
        public BookingUpdateStatusConsumerV2(IServiceScopeFactory scopeFactory, IConfiguration configuration)
        {
            _scopeFactory = scopeFactory;
            _configuration = configuration;
            var factory = new ConnectionFactory();
            _configuration.Bind("RabbitMqConnectionV2", factory);
            syncQueue = _configuration.GetValue<string>("NewUpdateBookingStatus");
