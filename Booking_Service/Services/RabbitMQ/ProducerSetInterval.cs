...
{
    public interface IProducerSetInterval : IDisposable
    {
        string Call(string message, string queue);
        void Close();
    }
    public class ProducerSetInterval: IProducerSetInterval
    {
        ...
        public ProducerSetInterval(IConfiguration configuration)
        {
